...
class ITP_Solver(object):
	...
	def __init__(self, generate_scenarios=False, generate_random_variables=False, printing_output=False, output_solutions=False, parameter_file_name="Data/hydro_multiasset_multiproduct_continuous_stochastic_MC_parameters_bm_OD.txt"):
		...
		self.scenario_generation_file_name			= "Data/" 						+ self.model_id + "_" + "scenario_generation_input.txt"														# Directory of the input parameter file for autogenerated scenarios
		self.variables_file_name					= "Output/VariableFiles/" 		+ self.model_id + "_" + datetime.datetime.now().strftime("%Y-%m-%d_%H.%M") + "variables.xlsx"				# Directory of the output file with all the optimal variable values
		self.random_variable_file_name				= "Output/RandomVariableFiles/" + self.model_id + "_" + datetime.datetime.now().strftime("%Y-%m-%d_%H.%M") + "random_variables.csv"			# Directory of the folder of the random variables 
