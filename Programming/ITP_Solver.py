...
class ITP_Solver(object):
	...
	def __init__(self, generate_scenarios=False, generate_random_variables=False, printing_output=False, output_solutions=False):
		...
		self.variables_file_name					= "Output/VariableFiles/" + datetime.datetime.now().strftime("%Y-%m-%d_%H.%M") + "variables.xlsx"	# Directory of the output file with all the optimal variable values
		self.random_variable_file_name				= "Output/RandomVariableFiles/" + datetime.datetime.now().strftime("%Y-%m-%d_%H.%M") + "random_variables.csv"															# Directory of the folder of the random variables 
